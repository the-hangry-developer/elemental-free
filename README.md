...
|---------------------------|---------|-------------|--------|
| Windows 10+               | v0.1.0  | [msi](https://github.com/the-hangry-developer/elemental-free/releases/download/v0.1.0/elemental-free-win64.msi) | ~46 MB |
| macOS 15+ (Apple Silicon) | v0.1.0  | [pkg](https://github.com/the-hangry-developer/elemental-free/releases/download/v0.1.0/elemental-free-macOS.pkg) | ~18 MB |
| Linux (Wayland)           | v0.1.0  | [deb](https://github.com/the-hangry-developer/elemental-free/releases/download/v0.1.0/elemental-free-Linux.deb) | ~20 MB |
...
[Verify checksums](docs/CHECKSUMS.md)
...
![Main dashboard](screenshots/dashboard-linux.jpg)  
![Model browser](screenshots/models-linux.jpg)  

[![Demo video](https://img.youtube.com/vi/J7IemPBeiW8/0.jpg)](https://youtu.be/J7IemPBeiW8)
